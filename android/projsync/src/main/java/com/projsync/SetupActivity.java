...
public class SetupActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub.setText("Enter your ProjSync server URL including this device's name:");
        sub.setTextSize(14);
        ...
        etUrl.setHint("http://192.168.x.x:5005/devicename/launcher");
    ...
    private void save() {
        ...
        getSharedPreferences("projsync_prefs", MODE_PRIVATE)
            .edit()
